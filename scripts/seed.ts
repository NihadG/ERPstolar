...
// Execute with: npx ts-node --skip-project scripts/seed.ts
...
async function seedDatabase() {
    ...
    const suppliers = [
        {
            ...
            Name: 'Drvo Comerc',
            Contact_Person: 'Marko Marković',
            Phone: '061-234-567',
            Email: 'info@drvo-comerc.ba',
            Address: 'Sarajevo, Ilidža',
            Categories: 'Ploča, Kanttraka'
        },
        {
            Supplier_ID: generateUUID(),
            Name: 'Okovi Plus',
            Contact_Person: 'Ana Anić',
            Phone: '062-345-678',
            Email: 'prodaja@okoviplus.ba',
            Address: 'Zenica',
            Categories: 'Okovi, Šarke, Ladičari, Ručke'
        },
        {
            Supplier_ID: generateUUID(),
            Name: 'Staklo Centar',
            Contact_Person: 'Ivan Ivić',
            Phone: '063-456-789',
            Email: 'narudzbe@staklocentar.ba',
            Address: 'Tuzla',
            Categories: 'Staklo, Alu vrata'
        }
    ];
    ...
    const products = [
        {
            ...
            Project_ID: projectId,
            Name: 'Gornji kuhinjski ormar 60x72',
            Height: 720,
            Width: 600,
            Depth: 320,
            Quantity: 4,
            Status: 'Na čekanju',
            Material_Cost: 0,
            Notes: 'Bijela boja sa hrast frontom'
        },
        {
            Product_ID: generateUUID(),
            Project_ID: projectId,
            Name: 'Donji kuhinjski element 80x85',
            Height: 850,
            Width: 800,
            Depth: 560,
            Quantity: 3,
    ...
    console.log('Adding second project...');
    ...
    const products2 = [
        {
            ...
            Status: 'Na čekanju',
            Material_Cost: 850,
            Notes: 'Sa ogledalom na srednjim vratima'
        },
        {
            Product_ID: generateUUID(),
            Project_ID: project2Id,
